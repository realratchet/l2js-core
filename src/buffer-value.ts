...
type PrimitiveNumberTypes_T = "float" | "int32" | "uint32" | "int8" | "uint8" | "int16" | "uint16";
type AllPrimitiveNumberTypes_T = BigNumberTypes_T | PrimitiveNumberTypes_T;
type NumberTypes_T = "compat32" | AllPrimitiveNumberTypes_T;
...
export { BufferValue };
export type { BigNumberTypes_T, PrimitiveNumberTypes_T, AllPrimitiveNumberTypes_T, NumberTypes_T, StringTypes_T, ValueTypeNames_T, ValidTypes_T };
